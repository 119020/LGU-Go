    ...
    table.innerHTML = `
        ...
        <tbody>
            ${competitions.map(competition => `
                <tr>
                    <td><a href="competitions.html?competition_base_id=${encodeURIComponent(competition.competition_base_id)}&competition_name=${encodeURIComponent(competition.competition)}">${competition.competition}</a></td>
